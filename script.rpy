...
label scene_3:
    ...
    if "q1" in variables.wrong_answers or not variables.wrong_answers:
        show irene speaking at left
    ...
    # show question only if they were none were asked yet or
    # if the question was answered incorrectly in the previous run
    if "q2" in variables.wrong_answers or not variables.wrong_answers:
        show irene speaking at left
...
label scene_6:
    ...
    if "q3" in variables.wrong_answers or not variables.wrong_answers:
        show titania speaking at left
    ...
    if "q4" in variables.wrong_answers or not variables.wrong_answers:
        show titania speaking at left
    ...
    if "q5" in variables.wrong_answers or not variables.wrong_answers:
        show titania speaking at left
    ...
    if "q6" in variables.wrong_answers or not variables.wrong_answers:
        show titania speaking at left
    ...
    if "q7" in variables.wrong_answers or not variables.wrong_answers:
